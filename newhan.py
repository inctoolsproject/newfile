...
cl = LINETCR.LINE()
cl.login(token="Emh4DsITSc5Z4blqt4K2.jYeuxTZd6gB4UG6y0brveG.9xIzSXgTPoNVWL4uZTNYTap5h9VVsi2lciBYSCgviuU=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EmvPDVAQK3izXZWif3l8.1RZ3Xw8kzjv1f315+XyUUa.FIoLFod/PmnduA5qF/ImNi2K3HrH+NlDYq67w9JRx48=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="Emg85X9AexDWj0W8gGp6.V1ByMKCIWXs/yF/qHh8xfG.aCGcSZy0KLnJVWY1YGu2mfkrqbQY9boocf+gLOaiWpQ=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EmEww7IMv8vnutyW3362.CLu18bMdHAHZiO4NVOTb0G.OuyTR/gQPRRiWmhNc4uFzjs7wk9zju9soqAXwm6wkII=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="Emmys5ArwTTCweo35lu7.GgY5TKq+DvVIRBxfmuVibW.vruDRURgejvkq1Yt5UP44kzjpqF3GtmRcSw/ARCSwoM=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="Em485E5BF1XKneZQUqud.kVZtPxkSKBtUyv4x1u0cpq.1keLBmbGU77ea+VFkGTDoVP5dWSFrnj1CM+f7W2N2Es=")
ki5.loginResult()

ki6 = LINETCR.LINE()
ki6.login(token="EmTZuS9JMhPgtEDM54Qd.ulzV1iVYslMuzF4KFRwmhq.SacHcBN+MCTq2xprg3JQ2ueix1bSOaWhgnj7GPPlogI=")
ki6.loginResult()

ki7 = LINETCR.LINE()
ki7.login(token="EmsCeKJ4gJHheyBREEp7.XVG7jTDun+Cckd2X6aGcvW.VmhH1LwknEIG03rhDvLVlGiiw87g8zEJrHb8k2nFxME=")
ki7.loginResult()

ki8 = LINETCR.LINE()
ki8.login(token="EmKGRrWdyppBQZRJZZx6.iili5a6hqaCmGFFaN/6+rG.ePp+lFka6T5TjX82o1VVbmdYRn8dU6TfW+o1tYQrOcs")
ki8.loginResult()
...
ki10 = LINETCR.LINE()
ki10.login(token="Em4LAgour1I3Tr5mEcc3.qCpLCqlV8mOtFs1yrxQXiW.s+vY8IP+b8lJe9iw6nZml4hRJLhF5fPdAh6UyIWXrfo=")
ki10.loginResult()

ki11 = LINETCR.LINE()
ki11.login(token="EmLu03yMgTzuBclHjGBa.8E/ul5u/ee++H5eGgLpJoG.lzHsfL8AhUuikuxW4dJrhK6bg9zIEUSrsmE1Hisicow=")
ki11.loginResult()

ki12 = LINETCR.LINE()
ki12.login(token="EmA1MWWMx1KcDdog30i4.wnJ9soA/a9iujPB5f9mxra.tQARv+qWBaCtjACT+pU/gnhtUGbfOz/8hyCx5Ughx9o=")
ki12.loginResult()

ki13 = LINETCR.LINE()
ki13.login(token="EmdP4waLLOnyrUIMJkL7.M+NGGNRiXkEcIB3q5kbprW.nmGi+8ECLcvOYfzKveiq6TxRjpgSWzZgHci6JLt3bmY=")
ki13.loginResult()

ki14 = LINETCR.LINE()
ki14.login(token="EmQ6MjxEYvoaJOcu5MT9.Z03CfqBvbIxrTyoxQmVrcq.85AUvELizEEjy23pC84Ic6Wbzad+wxStjbO+5SqwlUI=")
ki14.loginResult()

ki15 = LINETCR.LINE()
ki15.login(token="Em6GOCOUWUZoZYqk7SNd.f2LF9w+YP9UMia4Pe/Idtq.0zJk33NWjIUZ1nkf+LhllmEcDhY9yCL/+RoLgHAo0eU=")
ki15.loginResult()

ki16 = LINETCR.LINE()
ki16.login(token="Em7QkGh7sa8LHqMRfHJb.cC3MNdYMmgrpA3WcDXL9IW.RYmmErANKrNs2RYNb06HXA0NofXP1Ai9M6/wQqfNEuk=")
ki16.loginResult()

ki17 = LINETCR.LINE()
ki17.login(token="Emmys5ArwTTCweo35lu7.GgY5TKq+DvVIRBxfmuVibW.vruDRURgejvkq1Yt5UP44kzjpqF3GtmRcSw/ARCSwoM=")
ki17.loginResult()

ki18 = LINETCR.LINE()
ki18.login(token="EmsYXvgbRlIB6SKn5MX1.2EwvHPEDlk89bjDnvHcZeq.SE26FLTwwSORMXZ5wMJ0gRgI9yeD+ZMEfvQ/c3/0Djg=")
ki18.loginResult()
...
admsa = "u2721145edcc3e866f8ba0e98d0145512"
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u2721145edcc3e866f8ba0e98d0145512":
                    if "join:" in msg.text:
